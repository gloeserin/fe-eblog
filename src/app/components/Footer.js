...
const Footer = () => {
  return (
    <section id="contact" className="  bg-[#202142] font-poppins">
      <footer className="container mx-auto grid grid-cols-10 px-5 py-10 gap-y-10 gap-x-5 md:pt-20 md:grid-cols-12 lg:grid-cols-10 lg:gap-x-10">
       ...
       <div>
        <Image
          ...
          Understand the latest developments and emerging trends in various fields.
          </p>
        ...
        <div className="hidden md:flex flex-col items-center space-y-4 md:col-span-12 lg:col-span-10">
          ...
          <p className="font-bold italic text-white">
            Copyright © 2024. Crafted with love by me.
          </p>
        </div>
      </footer>
    </section>
